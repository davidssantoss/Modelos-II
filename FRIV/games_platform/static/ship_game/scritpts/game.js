(function() {
  ...
  state.preload = function() {
    ...
    this.addSpriteSheet('shipSprite', 'static/ship_game/images/player.PNG', 45, 36);
    this.addSpriteSheet('shoot', 'static/ship_game/images/shoot.png', 28, 28);
    this.addSpriteSheet('enemy', 'static/ship_game/images/enemy.png', 45, 62);
    this.addSpriteSheet('enemy_shoot', 'static/ship_game/images/enemy_shoot.png', 28, 28);
    this.addImage('background', 'static/ship_game/images/back.jpg');
  };
