...
sCampo.preload = function () {
    ...
    this.addSpriteSheet( 'jugador1', 'static/head_game/assets/Player/jugador1.png', 100, 100 );
    this.addImage( 'background', 'static/head_game/assets/Environment/estadio.jpg' );
    this.addSpriteSheet('piso','static/head_game/assets/Environment/grass.png',131,65);
    this.addSpriteSheet('arco1','static/head_game/assets/Environment/goal_2.png',133,241);
    this.addSpriteSheet('arco2','static/head_game/assets/Environment/goal_1.png',133,241);
    this.addSpriteSheet('balon','static/head_game/assets/Ball/ball1.png',60,60);
